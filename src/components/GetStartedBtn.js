...
import { json, redirect, useNavigate, Link, Form } from 'react-router-dom';
            ...
            <div className='top-line-btn'>
                <div className='flex'>
                    ...
                    <div className='mb-5px'>
                        ...
                        <button type="button" class="btn-theme" data-bs-toggle="modal" data-bs-target="#mail">
                            Get Started
                        </button>
                        {/* <!-- Modal --> */}
                                ...
                                <div class="modal-dialog modal-dialog-centered justify-center">
                                    <div class="body-modal modal-content bg-gray">
                                        <div class="title-modal d-flex">
                                            ...
                                            <h1 id="exampleModalLabel" className='m-auto align-center text-white'>Tell Us About Youself</h1>
                                        ...
                                        <div class="modal-body justify-center btn1 pb-1 ">
                                            <div>
                                                <div className='d-flex'>
                                                    <AiOutlineFileText className='e-icon'></AiOutlineFileText>
                                                    <input type="text" placeholder='Subject *' className='w-100' name='subject' id="subject"
                                                ...
                                                <div >
                                                    ...
                                                    {...register('username', { required: 'Subject is required' })}
                                                    />
                                                </div>
                                                {errors.username && <p className='error'>{errors.username.message}</p>}
                                                <div>
                                                    <AiOutlineMail className='e-icon'></AiOutlineMail>
                                                    <input type="text" placeholder='your email *' className='w-100 me-2' name='email'
                                                        id="email"
                                                        {...register('email', {
                                                ...
                                                <div>
                                                    <select name="c_code" id="c_code" className='mx-2 w-25'>
                                                    ...
                                                    <input type="text" placeholder='Mobile No.' name="mobileno" className='w-100 me-2' id='mobileno'
                                                        {...register('mobileno', {
                                                            required: 'Please Enter Phone/Mobile Number.',
                                                            pattern: {
                                                                value: /^\d{10}$/,
                                                                message: 'Please Enter Your 10 digits mobile number.',
                                                            },
                                                        })}
                                                    />
                                                </div>
                                        ...
                                        <div class="modal-footers d-flex justify-content-center ">
                                            <button type='submit' class="btn-theme send-btn-no"><RiSendPlaneFill className='me-2'></RiSendPlaneFill>Send Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
